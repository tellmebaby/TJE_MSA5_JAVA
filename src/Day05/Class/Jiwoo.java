...
//		pikachu.type = "전기";
		...
		Raichu raichu60 = new Raichu(650, "열반");
		System.out.println("########## 라이츄( Lv.60 ) ##########");
		System.out.println("에너지 : " + raichu60.energy);
		System.out.println("타입 : " + raichu60.type);
		System.out.println("공격 A : " + raichu60.aAttack());
		System.out.println("공격 B : " + raichu60.bAttack());
		System.out.println("공격 C : " + raichu60.cAttack());
		System.out.println("공격 D : " + raichu60.dAttack());
		System.out.println();
	}
}
