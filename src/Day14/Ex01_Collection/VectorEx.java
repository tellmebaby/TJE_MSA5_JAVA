...
public class VectorEx {
	...
	public static void main(String[] args) {
		...
		// Vector 객체 생성
		Vector<Integer> list = new Vector<Integer>(); // 기본 생성: 기본용량10, 2배씩 증분
		// 요소 추가
		list.add(1);
		list.add(2);
		list.add(3);
		...
		System.out.println(">>반복3 - iterator 활용한 반복");
		...
		// 삭제
		// - 삭제할 때, 삭제한 위치 뒤의 index 가 앞으로 한 칸 씩 당겨진다.
									// 0  	   1     2     3      4  
									// 아메리카노 녹차라떼 연유라떼 아이스티 돌체라떼
		vector.remove(0);			// 녹차라떼 연유라떼 아이스티 돌체라떼
		vector.remove(1);			// 녹차라떼 아이스티 돌체라떼
